...
Console.Write("\n");
string title = "ML.NET(Makine Öğrenimi) TR SPAM ANALİZİ";
string etic = "(Veri Kümesi Tweetler'den alınmıştır !)";
...
while (true)
{
    ...
    var sampleData = new Spamanalizmodel.ModelInput()
    {
        Col1 = input
    };
    ...
    var result = Spamanalizmodel.Predict(sampleData);

    // Tahmin edilen etiketi belirle
    var predictedLabel = result.PredictedLabel == "Pozitif" ? "Pozitif" : "Negatif";
